...
class PlayerViewController: UIViewController, UITableViewDelegate,UITableViewDataSource,AVAudioPlayerDelegate, MPMediaPickerControllerDelegate {
    ...
    @IBAction func openItunesLibraryTapped(_ sender: UIButton) {
    ...
    //MPMediaPicker Delegate Methods
